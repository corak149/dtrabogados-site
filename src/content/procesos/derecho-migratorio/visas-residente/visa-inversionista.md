...
documentos:
  ...
  - Documentación de fuente de fondos extranjera
  - Certificado de Registro Público (si aplica)
  - Certificación CPA
plazos:
  tramite: "Resolución en 30 días hábiles por Ventanilla Especial de Trámite"
...
notas_firma: |
  ...
  1. **Inversionistas inmobiliarios** — compra de propiedad por
     USD 300K o más, libre de gravámenes. Gestionamos la
     certificación MICI, la inscripción registral y el
     expediente SNM.

  2. **Accionistas de empresas panameñas** — inversión de USD
  ...
  3. **Inversionistas en actividades económicas específicas** —
...
La visa de inversionista calificado permite residencia permanente con
inversión mínima B/.300,000. La versión del frontmatter arriba es la
