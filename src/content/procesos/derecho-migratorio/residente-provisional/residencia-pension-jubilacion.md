---
titulo: Residencia por pensión o jubilación
...
documentos:
  ...
  - Si la pensión proviene de fondo privado, contrato del fondo y certificación de la Superintendencia del país de origen (cuando aplique)
...
plazos:
  tramite: 3 a 6 meses en el Servicio Nacional de Migración (SNM), desde la presentación completa del expediente
  vigencia: Residencia provisional por 2 años, prorrogable
  renovacion: Renovable por períodos iguales mientras se mantenga la pensión activa y el cumplimiento tributario en Panamá
honorarios_ref: "Honorarios según el Acuerdo CNA 609-A/2021. Cotizamos por escrito considerando si el solicitante trae dependientes (USD 1,000 base, USD 2,000 recomendado con familia) y la complejidad documental de la pensión de origen."
tasas_oficiales: "Tasa SNM B/.250 por la residencia + B/.50 por carné + costos de apostilla/legalización de la certificación de pensión (variable según país)"
alertas:
...
revisar_con: "800-Knowledge-PA/810-Migracion/811-Bloque-1-Normativa-y-Requisitos/811.7-Requisitos-SNM/811.7.2-Requisitos-Residente-Permanente/ (categoría jubilado) + 800-Knowledge-PA/810-Migracion/812-Bloque-2-Residencias/812.3-Residente-Temporal/"
ultima_actualizacion: 8 de agosto de 2026
---

La residencia por pensión o jubilación es una de las vías más consultadas
por clientes retirados. El campo `notas_firma` del frontmatter contiene las
observaciones sustantivas; este cuerpo markdown se mantiene vacío para que
toda la información se renderice desde los campos estructurados.
