...
documentos:
  ...
  - Certificación de la fuente de renta (banco, fondo de inversión, propiedad arrendada, etc.)
  ...
  - Extractos bancarios de los últimos 12 meses mostrando la renta mensual
...
plazos:
  tramite: 4 a 8 meses en el SNM, desde la presentación completa del expediente
  vigencia: La residencia permanente no vence; renovación del carné cada 5 años
  renovacion: Renovación del carné cada 5 años con verificación de que la fuente de renta sigue activa
honorarios_ref: "Honorarios según el Acuerdo CNA 609-A/2021. Cotizamos por escrito según la complejidad de la fuente de renta (inversiones simples vs. fideicomisos internacionales) y la documentación a traducir/apostillar."
tasas_oficiales: "Tasa SNM B/.250 + B/.50 por carné + apostillas y traducciones oficiales (variables según país y tipo de documento)"
alertas:
...
revisar_con: "800-Knowledge-PA/810-Migracion/811-Bloque-1-Normativa-y-Requisitos/811.7-Requisitos-SNM/811.7.2-Requisitos-Residente-Permanente/ (categoría rentista)"
ultima_actualizacion: 8 de agosto de 2026
---

La residencia permanente como rentista es una de las categorías más
consultadas por clientes con patrimonio internacional. El campo
`notas_firma` del frontmatter contiene las observaciones sustantivas;
este cuerpo markdown se mantiene vacío intencionalmente.
