...
documentos:
  ...
  - Carta del empleador (<strong>firma autenticada</strong>)
  - Copia de cédula o carné de residencia del empleador
  - Antecedentes penales apostillados
  - Certificado de salud
plazos:
  tramite: "15 a 30 días hábiles ante el SNM"
  vigencia: "1 año, prorrogable anualmente hasta 4 veces (máximo 5 años con el mismo empleador)"
  renovacion: "Anual, con confirmación de mantenimiento de la relación laboral con el mismo empleador. Si cambia de empleador, requiere nuevo trámite."
honorarios_ref: "Honorarios profesionales según el Acuerdo CNA 609-A/2021. Cotizamos considerando que el empleador asume la responsabilidad migratoria del trabajador."
tasas_oficiales: "Tasa SNM B/.250 + tasa consular si se solicita desde el exterior."
alertas:
...
revisar_con: "800-Knowledge-PA/810-Migracion/811-Bloque-1-Normativa-y-Requisitos/811.7-Requisitos-SNM/811.7.1-Requisitos-No-Residentes/810.2.1.09-requisitos-visa-domesticos-RESUMEN.md"
ultima_actualizacion: 8 de agosto de 2026
---

La visa de servicio doméstico cubre trabajadores del hogar con
empleador panameño o residente. La versión del frontmatter arriba es
la canónica; este cuerpo markdown se mantiene vacío intencionalmente
porque toda la información relevante se renderiza desde los campos
del schema.