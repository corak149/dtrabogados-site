...
documentos:
  ...
  - Certificación médica del país de procedencia
  - Carta del centro médico panameño
  - Antecedentes penales
  - Certificado de salud
plazos:
  tramite: "15 a 30 días hábiles ante el SNM"
  vigencia: "Hasta 9 meses (máximo). Coincide con la duración del tratamiento programado."
  renovacion: "NO es renovable. Para tratamientos que excedan 9 meses, debe solicitarse visa de residente por tratamiento médico prolongado (régimen general)."
honorarios_ref: "Honorarios profesionales según el Acuerdo CNA 609-A/2021. Cotizamos según duración del tratamiento y necesidad de acompañante."
...
notas_firma: |
  ...
  2. **Casos de segunda opinión médica** — paciente que viaja a
     Panamá para consulta con especialista antes de decidir
     tratamiento en su país de origen.

  3. **Turismo médico con tratamiento breve** — pacientes que
...
revisar_con: "800-Knowledge-PA/810-Migracion/811-Bloque-1-Normativa-y-Requisitos/811.7-Requisitos-SNM/811.7.1-Requisitos-No-Residentes/810.2.1.14-requisitos-corta-estancia-medico-RESUMEN.md"
ultima_actualizacion: 8 de agosto de 2026
---

La visa de corta estancia médica cubre tratamientos que no excedan 9
meses. La versión del frontmatter arriba es la canónica; este cuerpo
markdown se mantiene vacío intencionalmente porque toda la información
